(function() {
  ...
  describe('Part I', function() {
    ...
    describe('uniq', function() {
      ...
      it('should return all unique items from the input array based on their values when no iterator is provided as input', function() {
        var numbers = [1, 2, 1, 3, 1, 4];

        expect(_.uniq(numbers)).to.eql([1, 2, 3, 4]);
      });

      it('should return all unique items from the input array based on their transformed values when an iterator is provided as input', function() {
    ...
    describe('map', function() {
      ...
      it('should iterate over arrays and provide access to each index', function() {
        var letters = ['a', 'b', 'c'];
        var indexes = _.map(letters, function(letter, index) {
          return [letter, index];
        });
      ...
      it('should iterate over arrays and provide access to the original collection', function() {
        var letters = ['a', 'b', 'c'];
        var collections = _.map(letters, function(letter, index, collection) {
          return [letter, index, collection];
        });
    ...
    describe('reduce', function() {
      ...
      it('should return the initial value for memo when the input collection is empty', function() {
        var result = _.reduce([], function() {}, 'initial value');
      ...
      it('should continue to call iterator even if the iterator returns undefined', function() {
        ...
        var mayReturnUndefined = function(memo, item) {
          callCount += 1;
          if (callCount % 2 === 0) {
            return item;
          }
        ...
        _.reduce([1, 1, 1, 1, 1], mayReturnUndefined, 1);
        expect(callCount).to.equal(5);
      });

      it('should pass every item of the array into the iterator if an intial value for memo is passed in', function() {
      ...
      it('should initialize memo with the value of first item of the array if no initial value for memo is passed in', function() {
      ...
      it('should pass the second item of the array as the iterator\'s first item argument if an initial value for memo is not passed in', function() {
      ...
      it('should update memo every iteration even when iterator returns undefined', function() {
        var callCount = 0;
        ...
        var finalMemo = _.reduce([1, 2, 3], recordAndUpdateMemo);
        actualMemoVals.push(finalMemo);

        expect(actualMemoVals).to.eql(memoVals);
      });
